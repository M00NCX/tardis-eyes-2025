...
export function PlanetNavigation({
  ...
  return (
    <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-[500] bg-background/95 backdrop-blur-md rounded-full px-3 py-2 shadow-xl border border-border/50 flex items-center gap-3">
